...
- 🍽️ **[Food Storage App](https://github.com/NTNU-IDI/idatt1003-mappe-2024-Viet-Uy)** — A Java application for managing food storage and recipes: tracks expiration dates, and recommends recipes based on what's about to expire, to cut down food waste.
...
I got into tech through wanting to understand how games were built under the hood — that curiosity turned into a full engineering path.
